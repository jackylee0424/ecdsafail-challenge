...
fn configure_ecdsafail_submission_route() {
    match std::env::var("POINT_ADD_ROUTE_PRESET").ok().as_deref() {
        Some("q1175_dirty_qoffset_first") => {
            route_preset::apply_q1175_dirty_qoffset_first_experiment();
        }
        Some("q1175_dirty_qoffset_core") => {
            route_preset::apply_q1175_dirty_qoffset_core_experiment();
        }
        Some("q1175_boundary_borrow") => {
            route_preset::apply_q1175_boundary_borrow_experiment();
        }
        Some("q1175_apply_chunk_shape") => {
            route_preset::apply_q1175_apply_chunk_shape_experiment();
        }
        Some("q1175") | Some("q1175_repaired_clean_91794252") => {
            route_preset::apply_q1175_repaired_clean_91794252_experiment();
        }
        _ => route_preset::PointAddRoutePreset::accepted_cf310ec().apply_for_submission(),
    }
}
